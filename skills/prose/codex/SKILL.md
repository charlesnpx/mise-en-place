...
name: prose
description: >
  Write answers in concise, flowing technical prose with a direct, conversational
  senior-engineer voice. Use when the user invokes prose, /prose, or $prose, or
  asks for an answer in this style.
---

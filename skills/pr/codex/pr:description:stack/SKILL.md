...
Launch one subagent per stack branch. Keep at most 6 Codex subagents active at once. Start the next queued worker as soon as one completes until all descriptions are written.
